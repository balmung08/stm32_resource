...
#define PIN_AM2302        GPIO_Pin_7
 
#define	DHT22_DQ_OUT 			PGout(7) 		//PG11_out  
#define	DHT22_DQ_IN  			PGin(7)   		//PG11_in
 
/* DHT22 I/O口方向设置 */
#define DHT22_IO_IN()  {GPIOG->CRL&=0X0FFFFFFF;GPIOG->CRL|=8<<28;}	//PG11_in		 Floating 	input
#define DHT22_IO_OUT() {GPIOG->CRL&=0X0FFFFFFF;GPIOG->CRL|=3<<28;}	//PG11_out	 Pull-Push output
